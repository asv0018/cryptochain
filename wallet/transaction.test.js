...
describe('Transaction', ()=>{
    ...
    describe('update()', ()=>{
        ...
        describe('and the amount is valid', ()=>{
            ...
            it('maintains a total output that matches with the input amount',()=>{
    ...
    describe('rewardTransaction()', ()=>{
        ...
        it('creates ones transactions for the miner with the `MINING-REWARD`', ()=>{
